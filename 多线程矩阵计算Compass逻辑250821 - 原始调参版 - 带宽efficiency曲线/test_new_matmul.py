...
def run_one(index: int, s: str, compile_mode: str = "fast"):
    """
    ...
    try:
        ...
        # compile & simulate
        sim_latency = model.compile_and_simulate(HW, compile_mode=compile_mode)
...
def main():
    ...
    parser.add_argument("--mode", type=str, default="fast", choices=["fast", "exhaustive"],
   ...
   #可注释！！！！！
    ...
    with ProcessPoolExecutor(max_workers=args.workers) as ex:
        fut2idx = {ex.submit(run_one, idx, s, args.mode): idx for idx, s in tasks}
